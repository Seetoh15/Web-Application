<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/template.Master" AutoEventWireup="true" CodeBehind="forumAdmin.aspx.cs" Inherits="WAPP_Assignment.Admin.forumAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="forumAdmin.css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="width:70%; height:100%; display:flex; flex-direction:column; gap:10px;">
            <asp:Repeater ID="PostsRepeater" runat="server">
                <ItemTemplate>
                    <a href="commentAdmin.aspx?post_id=<%# Eval("post_id") %>">
    ...
    <script src="forumAdmin.js"></script>
</asp:Content>
