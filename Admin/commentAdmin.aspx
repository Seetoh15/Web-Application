<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/template.Master" AutoEventWireup="true" CodeBehind="commentAdmin.aspx.cs" Inherits="WAPP_Assignment.Admin.commentAdmin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="commentAdmin.css" />
    <script>
                    ...
                    <div style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 10px; background: white; border-radius: 10px;">
                        <div style="display: flex; flex-direction: row; margin-top: 10px; width: 100%;">
                            ...
                            <div style="display: flex; flex-direction: column; margin-left: 10px; width: 100%;">
                                ...
                                <span style="color: lightslategrey; font-size: 13px;">By
                                    <asp:Literal ID="litUsername" runat="server"></asp:Literal>
                                    <asp:Literal ID="litCreatedAt" runat="server"></asp:Literal></span>
                            </div>
                        </div>
