<%@ Page Title="" Language="C#" MasterPageFile="~/Member/template.Master" AutoEventWireup="true" CodeBehind="forumpage.aspx.cs" Inherits="WAPP_Assignment.Member.forumpage" %>
    ...
    <div style="width:100%; height:100%; display:flex; flex-direction:column; align-items:center; gap:20px; padding-top:20px;">
        ...
        <div style="width:70%; height:100%; display:flex; flex-direction:column; gap:10px;">
            <asp:Repeater ID="PostsRepeater" runat="server">
                <ItemTemplate>
                    <a href="postForum.aspx?post_id=<%# Eval("post_id") %>">
